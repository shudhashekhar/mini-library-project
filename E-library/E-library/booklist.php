...
include("Comp/connect.php");
		...
		$q1 = "SELECT * FROM booklist WHERE book_name LIKE '%$book_name%'";
			...
			if($total1>0)
			{
					for($i=0;$i<$total1;$i++)
						...
						echo "<tr>
							...
							<td><a href='editbook.php?book_name=$result1[book_name]&author_name=$result1[author_name]&id=$result1[id]'>Edit</a></td>
							<td><a href='delete.php?book_name=$result1[book_name]&author_name=$result1[author_name]' onclick=' return checkdelete()'>DELETE</a></td>
						</tr>";
						}
			}else{
