<?php
	...
	if(isset($_POST['submit']))
	{
		...
		echo '<script>window.location.replace("booklist.php");
					</script>';
	}
?>
<!DOCTYPE html>
...
<head>
		...
		<style type="text/css">
			...
			.hero-image
				{
				background-image:url("Images/pic12.jfif");
		...
		<div class="col-md-4">
			...
			<form role="form" method="POST" align="center">
				<div class="form" align="left">
					<label><b>BOOK NAME : </b></label><input type="text" class="form-control" name="book_name" placeholder="Enter book name" aria-describedby="basic-addon1" ><br/>
				</div>
				<div class="form" align="center">
