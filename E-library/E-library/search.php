	...
	<br/><br/>
		<div class="row">
			...
			<div id="menu" class="col-xs-4" >
				<h2 style="text-align:center;font-size:40px;"><b>Admin Panel</b></h2><br>
				<div>
					...
					<a style="font-size:30px;color:magenta;" href="#"><b>Show...</b></a><br><br>	
						<button id="button" onclick="document.location='booklist.php'">Book List</button><br><br>					
					<a style="font-size:30px;color:magenta;" href="#"><b>Add New...</b></a><br><br>
						<button id="button" onclick="document.location='addbook.php'">Add New Book</button><br>
				</div>
			</div>
